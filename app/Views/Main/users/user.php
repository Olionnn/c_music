  ...
  <table class="table table-borderless table-dark">
    ...
    <?php $no=1; foreach($users as $row) { ?>
      <tr>
        ...
        <td scope="row" colspan=""><?php echo $row['user_username'] ?></td>
        <td scope="row" colspan=""><?php echo $row['user_email'] ?></td>
        <td scope="row" colspan=""><?php echo $row['user_nohp'] ?></td>
        <td scope="row" colspan=""><?php echo $row['user_signup_date'] ?></td>
        <td scope="row" colspan=""><?php echo $row['user_pictprofile'] ?></td>
        <td scope="row">
          <a class="btn btn-warning btn-sm btn-edit" data-toggle="modal" data-target="#editModal" href="#" data-user_id="<?= $row['user_id'];?>" data-user_username="<?= $row['user_username'];?>" data-user_password="<?= $row['user_password'];?>" data-user_email="<?= $row['user_email'];?>" data-user_nohp="<?= $row['user_nohp'];?>" data-user_pictprofile="<?= $row['user_pictprofile'];?>">
            Edit
          </a>
